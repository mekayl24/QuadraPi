...
def move_servo(channel, angle):
    anglemod = 180 * (angle/120)
    
    kit.servo[channel].angle = anglemod
...
# kit.servo[L_Back_Ankle].angle = 180 #knee perp to ground facing down, set to 180 for assembly
...
#Trying to write an accurate servo command

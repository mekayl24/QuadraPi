...
def testMove():
        # Initialize servos to 90 degrees (middle position)
    kit.servo[L_Front_Hip].angle = 100
    kit.servo[L_Front_Knee].angle =110
    kit.servo[L_Front_Ankle].angle = 110

    kit.servo[R_Front_Hip].angle = 85
    kit.servo[R_Front_Knee].angle = 70 #increasing makes less perpenic
    kit.servo[R_Front_Ankle].angle = 70 #increasing makes less perp.

    kit.servo[L_Back_Hip].angle = 100
    kit.servo[L_Back_Ankle].angle =110 #increasing == more perpendicular
    kit.servo[L_Back_Knee].angle = 110

    kit.servo[R_Back_Hip].angle = 102
    kit.servo[R_Back_Ankle].angle = 70
    kit.servo[R_Back_Knee].angle = 70
    return
